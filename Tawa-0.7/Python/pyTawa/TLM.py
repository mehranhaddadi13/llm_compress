...
def TLM_valid_model (model):
    ...
    libTawa.TLM_valid_model.restype=c_uint
    libTawa.TLM_valid_model.argtypes=[c_uint]
    return (libTawa.TXT_valid_model (model))

def TLM_valid_coder (coder):
    """ Returns a non-zero coder number if the coder is a valid coder, zero otherwize. """
    libTawa.TLM_valid_coder.restype=c_uint
    libTawa.TLM_valid_coder.argtypes=[c_uint]
    return (libTawa.TLM_valid_coder (coder))

def TLM_create_arithmetic_coder ():
    """ Creates and returns the default arithmetic coder. """
    libTawa.TLM_create_arithmetic_coder.restype=c_uint
...
def TLM_create_arithmetic_encoder (input_fileid, output_fileid):
    ...
    libTawa.TLM_create_arithmetic_encoder.restype=c_uint
...
def TLM_create_arithmetic_decoder (input_fileid, output_fileid):
    ...
    libTawa.TLM_create_arithmetic_decoder.restype=c_uint
...
def TLM_release_coder (coder):
   ...
   be reused in later TLM_create_coder calls). """
    libTawa.TLM_release_coder.restype=c_void_p
    libTawa.TLM_release_coder.argtypes=[c_uint]
    libTawa.TLM_release_coder (coder)

def TLM_valid_context (model, context):
    """ Returns non-zero if the model is valid, zero otherwize. """
    libTawa.TLM_valid_context.argtypes=[c_uint,c_uint]
...
def TLM_overlay_context (model, old_context, context):
   ...
   models with supplementary symbols are being created. """
    libTawa.TLM_overlay_context.restype=c_void_p
    libTawa.TLM_overlay_context.argtypes=[c_uint,c_uint,c_uint]
...
def TLM_set_context_operation (context_operation):
   ...
   The argument operation_type is one of the following:
	 ...
	 escapes occur). """
    libTawa.TLM_set_context_operation.restype=c_void_p
    libTawa.TLM_set_context_operation.argtypes=[c_uint]
...
def TLM_find_symbol (model, context, symbol):
    ...
    libTawa.TLM_find_symbol.restype=c_void_p
    libTawa.TLM_find_symbol.argtypes=[c_uint,c_uint,c_uint]
...
def TLM_update_context (model, context, symbol):
   ...
   sentinel symbol. """
    libTawa.TLM_update_context.restype=c_void_p
    libTawa.TLM_update_context.argtypes=[c_uint,c_uint,c_uint]
...
def TLM_suspend_update (model):
   ...
   added to (based on how much each requires to encode it, say). """
    libTawa.TLM_suspend_update.restype=c_void_p
    libTawa.TLM_suspend_update.argtypes=[c_uint]
    libTawa.TLM_suspend_update (model)

def TLM_resume_update (model):
    """ Resumes the update for a model. See TLM_suspend_update (). """
    libTawa.TLM_resume_update.restype=c_void_p
    libTawa.TLM_resume_update.argtypes=[c_uint]
...
def TLM_release_context (model, context):
   ...
   be reused in later TLM_create_context or TLM_copy_context calls). """
    libTawa.TLM_release_context.restype=c_void_p
    libTawa.TLM_release_context.argtypes=[c_uint,c_uint]
    libTawa.TLM_release_context (model, context)

def TLM_create_coderanges ():
    """ Return a new pointer to a list of coderanges. """
    libTawa.TLM_create_coderanges.restype=c_void_p
...
def TLM_append_coderange (coderanges, lbnd, hbnd, totl):
    ...
    libTawa.TLM_append_coderange.restype=c_void_p
    libTawa.TLM_append_coderange.argtypes=[c_uint,c_uint,c_uint,c_uint]
...
def TLM_reset_coderanges (coderanges):
    ...
    libTawa.TLM_reset_coderanges.restype=c_void_p
    libTawa.TLM_reset_coderanges.argtypes=[c_uint]
    libTawa.TLM_reset_coderanges (coderanges)

def TLM_release_coderanges (coderanges):
    """ Release the coderange list to the used list """
    libTawa.TLM_release_coderanges.restype=c_void_p
    libTawa.TLM_release_coderanges.argtypes=[c_uint]
...
def TLM_codelength_coderanges (coderanges):
   ...
   altering the current symbol or the current coderange. """
    libTawa.TLM_codelength_coderanges.argtypes=[c_uint]
...
def TLM_dump_coderanges (fileid, coderanges):
    ...
    libTawa.TLM_dump_coderanges.restype=c_void_p
    libTawa.TLM_dump_coderanges.argtypes=[c_uint,c_uint]
    libTawa.TLM_dump_coderanges (fileid, coderanges)

def TLM_copy_coderanges (coderanges):
    """ Creates a copy of the list of coderanges and returns a unsigned int pointer to it. """
    libTawa.TLM_copy_coderanges.restype=c_uint
    libTawa.TLM_copy_coderanges.argtypes=[c_uint]
...
def TLM_reset_symbol (model, context):
   ...
   current position. """
    libTawa.TLM_reset_symbol.restype=c_void_p
    libTawa.TLM_reset_symbol.argtypes=[c_uint,c_uint]
...
def TLM_get_symbol (model, context):
    ...
    libTawa.TLM_get_symbol.restype=c_uint
    libTawa.TLM_get_symbol.argtypes=[c_uint,c_uint]
...
def TLM_encode_symbol (model, context, symbol, coder):
   ...
   context becomes the encoded symbol. """
    libTawa.TLM_encode_symbol.restype=c_void_p
    libTawa.TLM_encode_symbol.argtypes=[c_uint,c_uint,c_uint,c_uint]
...
def TLM_decode_symbol (model, context, coder):
   ...
   decoded symbol. """
    libTawa.TLM_decode_symbol.restype=c_uint
    libTawa.TLM_decode_symbol.argtypes=[c_uint,c_uint,c_uint]
...
def TLM_dump_PPM_model (fileid, model):
    ...
    libTawa.TLM_dump_PPM_model.restype=c_void_p
    libTawa.TLM_dump_PPM_model.argtypes=[c_uint,c_uint]
...
def TLM_load_model (fileid):
   ...
   allocates it a new model number which is returned. """
    libTawa.TLM_load_model.restype=c_uint
    libTawa.TLM_load_model.argtypes=[c_uint]
...
def TLM_load_models (filename):
    ...
    libTawa.TLM_load_models.restype=c_void_p
...
def TLM_read_model (filename, debug_line, error_line):
    ...
    libTawa.TLM_read_model.restype=c_uint
...
def TLM_write_model (fileid, model, model_form):
   ...
   dynamic when it is later reloaded using TLM_load_model. """
    libTawa.TLM_write_model.restype=c_void_p
    libTawa.TLM_write_model.argtypes=[c_uint,c_uint,c_uint]
...
def TLM_release_model (model):
   ...
   a model that still has active contexts pointing at it. """
    libTawa.TLM_release_model.restype=c_void_p
    libTawa.TLM_release_model.argtypes=[c_uint]
    libTawa.TLM_release_model (model)

def TLM_copy_model (model):
    """ Copies the model. """
    libTawa.TLM_copy_model.restype=c_uint
    libTawa.TLM_copy_model.argtypes=[c_uint]
...
def TLM_nullify_model (model):
   ...
   to it. """
    libTawa.TLM_nullify_model.restype=c_void_p
    libTawa.TLM_nullify_model.argtypes=[c_uint]
...
def TLM_minlength_model (model):
   ...
   useful for computing minimum description lengths of messages. """
    libTawa.TLM_minlength_model.restype=c_uint
    libTawa.TLM_minlength_model.argtypes=[c_uint]
    return (libTawa.TLM_minlength_model (model))

def TLM_numberof_models ():
    """ Returns the number of currently valid models. """
    libTawa.TLM_numberof_models.restype=c_uint
...
def TLM_getcontext_position (model, context):
   ...
   converge in the Viterbi or trellis-based algorithms.) """
    libTawa.TLM_getcontext_position.restype=c_uint
    libTawa.TLM_getcontext_position.argtypes=[c_uint,c_uint]
...
def TLM_get_tag1 (model):
    ...
    libTawa.TLM_get_tag.argtypes=[c_uint]
...
def TLM_getmodel_tag (tag):
   ...
   occurs more than once, it will return the lowest model number. """
    libTawa.TLM_getmodel_tag.restype=c_uint
...
def TLM_extend_alphabet_size (model,alphabet_size):
    ...
    libTawa.TLM_extend_alphabet_size.restype=c_void_p
    libTawa.TLM_extend_alphabet_size.argtypes=[c_uint,c_char_p]
...
def TLM_sizeof_model (model):
   ...
   model in memory. """
    libTawa.TLM_sizeof_model.restype=c_uint
    libTawa.TLM_sizeof_model.argtypes=[c_uint]
