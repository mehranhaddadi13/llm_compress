...
def usage ():
    print ("Usage: encode [options] -i input-text -o output-text",
	   "",
	   "options:",
	   ...
	   "  -r\tdebug arithmetic coding ranges, file=sys.stderr")
...
""" Initializes the arguments dictionary from the command line. """

    opts_dict = {
	'-F': ('Performs Full Excls', True),
        '-U': ('Performs Update Excls', True),
	'-N': ('Encode Numbers', False),
        '-a': ('Alphabet Size', 'Int'),
        '-d': ('Dump Model', False),
        '-e': ('Escape Method', 'Str'),
